...
public class Vo_Movimiento {
   ...
   private  String pieza;
    ...
    public Vo_Movimiento(String movimiento_id, String partida_id, String posicion_x, String posicion_y, String rotacion, String tiempo, String pieza) {
    ...
    public Vo_Movimiento(String movimiento_id, String partida_id, String posicion_x, String posicion_y, String rotacion, String pieza) {
        this.movimiento_id = movimiento_id;
        this.partida_id = partida_id;
        this.posicion_x = posicion_x;
        this.posicion_y = posicion_y;
